...
where MIT..PowerMeterMaster.MeterName like 'MDB1-1' and MIT..PowerMeterData.AddDate between ('2017-05-15') and ('2017-05-21') 
ORDER BY
row_number()over 
...
FROM MIT..PowerMeterData (NOLOCK)
join MIT..PowerMeterMaster (NOLOCK) on MIT..PowerMeterData.PMMID = MIT..PowerMeterMaster.PMMID 
where MIT..PowerMeterMaster.MeterName like 'MDB2-1' and MIT..PowerMeterData.AddDate between ('2017-05-15') and ('2017-05-21')
ORDER BY
row_number()over 
(partition by dateadd(hour, datediff(hour, 0, MIT..PowerMeterData.AddDate),0) ORDER BY MIT..PowerMeterData.AddDate ) "
...
FROM MIT..PowerMeterData (NOLOCK)
join MIT..PowerMeterMaster (NOLOCK) on MIT..PowerMeterData.PMMID = MIT..PowerMeterMaster.PMMID 
where MIT..PowerMeterMaster.MeterName like 'MDB2-2' and MIT..PowerMeterData.AddDate between ('2017-05-15') and ('2017-05-21')
ORDER BY
row_number()over 
(partition by dateadd(hour, datediff(hour, 0, MIT..PowerMeterData.AddDate),0) ORDER BY MIT..PowerMeterData.AddDate ) "
...
FROM MIT..PowerMeterData (NOLOCK)
join MIT..PowerMeterMaster (NOLOCK) on MIT..PowerMeterData.PMMID = MIT..PowerMeterMaster.PMMID 
where MIT..PowerMeterMaster.MeterName like 'MDB2-3' and MIT..PowerMeterData.AddDate between ('2017-05-15') and ('2017-05-21')
ORDER BY
row_number()over 
(partition by dateadd(hour, datediff(hour, 0, MIT..PowerMeterData.AddDate),0) ORDER BY MIT..PowerMeterData.AddDate ) "
...
FROM MIT..PowerMeterData (NOLOCK)
join MIT..PowerMeterMaster (NOLOCK) on MIT..PowerMeterData.PMMID = MIT..PowerMeterMaster.PMMID 
where MIT..PowerMeterMaster.MeterName like 'MDB3-1' and MIT..PowerMeterData.AddDate between ('2017-05-15') and ('2017-05-21') 
ORDER BY
row_number()over 
(partition by dateadd(hour, datediff(hour, 0, MIT..PowerMeterData.AddDate),0) ORDER BY MIT..PowerMeterData.AddDate ) "
...
FROM MIT..PowerMeterData (NOLOCK)
join MIT..PowerMeterMaster (NOLOCK) on MIT..PowerMeterData.PMMID = MIT..PowerMeterMaster.PMMID 
where MIT..PowerMeterMaster.MeterName like 'MDB3-2' and MIT..PowerMeterData.AddDate between ('2017-05-15') and ('2017-05-21') 
ORDER BY
row_number()over 
(partition by dateadd(hour, datediff(hour, 0, MIT..PowerMeterData.AddDate),0) ORDER BY MIT..PowerMeterData.AddDate ) "
...
FROM MIT..PowerMeterData (NOLOCK)
join MIT..PowerMeterMaster (NOLOCK) on MIT..PowerMeterData.PMMID = MIT..PowerMeterMaster.PMMID 
where MIT..PowerMeterMaster.MeterName like 'MDB4-1' and MIT..PowerMeterData.AddDate between ('2017-05-15') and ('2017-05-21')
ORDER BY
row_number()over 
(partition by dateadd(hour, datediff(hour, 0, MIT..PowerMeterData.AddDate),0) ORDER BY MIT..PowerMeterData.AddDate ) "
...
FROM MIT..PowerMeterData (NOLOCK)
join MIT..PowerMeterMaster (NOLOCK) on MIT..PowerMeterData.PMMID = MIT..PowerMeterMaster.PMMID 
where MIT..PowerMeterMaster.MeterName like 'MDB4-2' and MIT..PowerMeterData.AddDate between ('2017-05-15') and ('2017-05-21')
ORDER BY
row_number()over 
(partition by dateadd(hour, datediff(hour, 0, MIT..PowerMeterData.AddDate),0) ORDER BY MIT..PowerMeterData.AddDate ) "
...
FROM MIT..PowerMeterData (NOLOCK)
join MIT..PowerMeterMaster (NOLOCK) on MIT..PowerMeterData.PMMID = MIT..PowerMeterMaster.PMMID 
where MIT..PowerMeterMaster.MeterName like 'MDB5-1' and MIT..PowerMeterData.AddDate between ('2017-05-15') and ('2017-05-21') 
ORDER BY
row_number()over 
(partition by dateadd(hour, datediff(hour, 0, MIT..PowerMeterData.AddDate),0) ORDER BY MIT..PowerMeterData.AddDate ) "
...
FROM MIT..PowerMeterData (NOLOCK)
join MIT..PowerMeterMaster (NOLOCK) on MIT..PowerMeterData.PMMID = MIT..PowerMeterMaster.PMMID 
where MIT..PowerMeterMaster.MeterName like 'MDB6-1' and MIT..PowerMeterData.AddDate between ('2017-05-15') and ('2017-05-21') 
ORDER BY
row_number()over 
(partition by dateadd(hour, datediff(hour, 0, MIT..PowerMeterData.AddDate),0) ORDER BY MIT..PowerMeterData.AddDate ) "
...
FROM MIT..PowerMeterData (NOLOCK)
join MIT..PowerMeterMaster (NOLOCK) on MIT..PowerMeterData.PMMID = MIT..PowerMeterMaster.PMMID 
where MIT..PowerMeterMaster.MeterName like 'MDB6-2' and MIT..PowerMeterData.AddDate between ('2017-05-15') and ('2017-05-21')
ORDER BY
row_number()over 
(partition by dateadd(hour, datediff(hour, 0, MIT..PowerMeterData.AddDate),0) ORDER BY MIT..PowerMeterData.AddDate ) "
...
FROM MIT..PowerMeterData (NOLOCK)
join MIT..PowerMeterMaster (NOLOCK) on MIT..PowerMeterData.PMMID = MIT..PowerMeterMaster.PMMID 
where MIT..PowerMeterMaster.MeterName like 'MDB7-1' and MIT..PowerMeterData.AddDate between ('2017-05-15') and ('2017-05-21') 
ORDER BY
row_number()over 
(partition by dateadd(hour, datediff(hour, 0, MIT..PowerMeterData.AddDate),0) ORDER BY MIT..PowerMeterData.AddDate ) "
...
FROM MIT..PowerMeterData (NOLOCK)
join MIT..PowerMeterMaster (NOLOCK) on MIT..PowerMeterData.PMMID = MIT..PowerMeterMaster.PMMID 
where MIT..PowerMeterMaster.MeterName like 'MDB7-2' and MIT..PowerMeterData.AddDate between ('2017-05-15') and ('2017-05-21') 
ORDER BY
row_number()over 
(partition by dateadd(hour, datediff(hour, 0, MIT..PowerMeterData.AddDate),0) ORDER BY MIT..PowerMeterData.AddDate ) "
...
data1.1 <- data1.1[order(data1.1$DateTime),]
data2.1 <- data2.1[order(data2.1$DateTime),]
data2.2 <- data2.2[order(data2.2$DateTime),]
data2.3 <- data2.3[order(data2.3$DateTime),]
data3.1 <- data3.1[order(data3.1$DateTime),]
data3.2 <- data3.2[order(data3.2$DateTime),]
data4.1 <- data4.1[order(data4.1$DateTime),]
data4.2 <- data4.2[order(data4.2$DateTime),]
data5.1 <- data5.1[order(data5.1$DateTime),]
data6.1 <- data6.1[order(data6.1$DateTime),]
data6.2 <- data6.2[order(data6.2$DateTime),]
data7.1 <- data7.1[order(data7.1$DateTime),]
data7.2 <- data7.2[order(data7.2$DateTime),]
...
write.csv(meter_all, file = "Report_15to21_05.csv",row.names=FALSE)